...
from . import logger
from .triangulation import create_db_from_model
from .utils.database import COLMAPDatabase, camTodatabase
...
def main(sfm_dir, image_dir, pairs, features, matches,
    ...
    # dir_path="/home/lys/Workplace/datasets/test"
    # for root,dirs,files in os.walk(dir_path):
    #     print()
    # reference = pycolmap.Reconstruction()
    # camera_id = 1
    # cam = pycolmap.Camera('SIMPLE_PINHOLE', 480, 640, [469.95,239.70,317.12], camera_id)
    # reference.add_camera(cam)
    # for i in range(37):
    #     img=pycolmap.Image("db/"+files[i], [], [0., 0., 0.], [1.,0.,0.,0.], camera_id, id=(i+1))
    #     reference.add_image(img)
    ...
    # camTodatabase("/home/lys/Workplace/datasets/site_1_outputs/colmap/sfm_superpoint+superglue/cameras_check.txt")
